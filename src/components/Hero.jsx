...
const Hero = () => {
  ...
  useGSAP(()=>{
    if(hasClicked) {
        ...
        gsap.from('#current-video', {transform:'center center', scale:0, duration:1.5, ease:'power1.inOut'})
    }
        ...
        >
          ...
          <div className="absolute left-0 top-0 z-40 size-full">
            <div className="mt-24 px-5 sm:px-10 ">
              ...
              <NewButton id="watch-trailer" title="Watch Trailer" leftIcon={<TiLocationArrow />} containerClass="!bg-yellow-300 flex-center gap-1"  />
            </div>
          </div>
        </div>
